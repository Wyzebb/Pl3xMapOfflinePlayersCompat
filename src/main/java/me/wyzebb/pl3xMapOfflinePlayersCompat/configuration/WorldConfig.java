package me.wyzebb.pl3xMapOfflinePlayersCompat.configuration;
...
public class WorldConfig extends AbstractConfig {
    ...
    public void reload() {
        Path mainDir = Pl3xMapOfflinePlayersCompat.getPlugin(Pl3xMapOfflinePlayersCompat.class).getDataFolder().toPath();
